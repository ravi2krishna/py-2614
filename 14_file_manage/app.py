...
# -> Use Persistent Storage i.e Save Data To Disk (File - JSON)
...
def save_students():
    ...
    # This error happens because the (JSON) format does not have a native set data type
    # To fix this, you must convert the set into a list 
    json_data_fix = {
