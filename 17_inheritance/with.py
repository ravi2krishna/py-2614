# With Inheritance - We Don't Need To Write Same Functionalities Again and Again For Multiple Times 
...
class SuperAdmin(VideoAdmin):
    ...
    def delete_videos(self):
        ...
        # Now Technically We Have 15k lines of Code - Duplicated Code is 0 lines i.e NO Duplicate Code 
